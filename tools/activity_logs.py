from tools.azure_client import azure_get
import urllib.parse
...
def get_activity_logs(
    ...
    Args:
        ...
        filter_text: Optional — filter by resource name or keyword
    ...
    if filter_text:
        time_filter += f" and resourceId contains '{filter_text}'"
    if correlation_id:
    ...
    return {
        ...
        "count": len(trimmed),
        "summary": (
            f"Found {len(trimmed)} activity log events in the last {hours_back} hours"
